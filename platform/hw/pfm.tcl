...
#DDR interfaces
set_property PFM.AXI_PORT {S11_AXI {memport "S_AXI_HP" sptag lpddr0} S12_AXI {memport "S_AXI_HP" sptag lpddr0} M00_AXI {memport "M_AXI_NOC" sptag "GP"}} [get_bd_cells /axi_noc_0]
